...
export const appApi = {
  list: () => http.get<App[]>('/v1/admin/apps').then((r) => r.data),
  create: (body: CreateAppInput) => http.post<App>('/v1/admin/apps', body).then((r) => r.data),
  update: (id: number, body: UpdateAppInput) =>
    http.patch<App>(`/v1/admin/apps/${id}`, body).then((r) => r.data),
